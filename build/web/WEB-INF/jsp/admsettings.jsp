                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <form id="adpropr" enctype="multipart/form-data" method="post">
                                        <label>
                                            <img class="profile-user-img img-responsive img-circle" src="resources/images/${cuAdmin.ppic}${cuUser.ppic}" alt="img" style="margin-left: 60px">
                                            <input type="file" id="dfcvo" name="cvupload" style="display: none"/>
                                        </label>
                                    </form>
                                    <h3 class="profile-username text-center">${cuUser.firstName} ${cuUser.lastName}${cuAdmin.firstName} ${cuAdmin.lastName}</h3>

                                    <p class="text-muted text-center" id="adminaa"><span class="label label-success" style="cursor: pointer">Update Pic</span></p>
                        ...
                        <div class="col-md-9">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#settings2" data-toggle="tab">Reg Users</a></li>
                                    <li><a href="#settings3" data-toggle="tab">Users Manage</a></li>
                                </ul>
                                        ...
                                        <form  id="usermf">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="fname" id="fname" placeholder="First Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Last Name</label>
                                                    <input type="email" class="form-control"  name="lname" id="lname" placeholder="Last Name">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control"  id="upass2" placeholder="confirm">
                                                </div>
                                            </div>
                                            <!-- /.box-body -->

                                            <div class="box-footer">
                                                <button type="button" id="usregi" class="btn btn-primary pull-right">Register</button>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <form  id="kwe">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="str" id="userch" placeholder="Email">
                                                </div> 
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Current Status  : </label>
                                                    <span type="email" class="label label-success"  id="usta"></span>
                                                </div> 
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Update State</label>
                                                    <select type="email" class="form-control" name="state"  placeholder="Email">
                                            ...
                                            <!-- /.box-body -->
                                            <div class="box-footer">
                                                <button type="button" id="seouuu" class="btn btn-primary pull-right" style="margin-left: 10px">Search</button>
                                                <button type="button" id="ssave" class="btn btn-primary pull-right">Save</button>
